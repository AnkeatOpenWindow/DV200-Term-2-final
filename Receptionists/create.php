...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["profileimage"]["tmp_name"], $targetFile)) {
            ...
            $sql = "INSERT INTO receptionists (profileimage, name, surname, age, gender, email, password, phonenumber, rank) VALUES ('$targetFile','$name', '$surname', '$age', '$gender', '$email', '$password','$phonenumber', '$rank')";
